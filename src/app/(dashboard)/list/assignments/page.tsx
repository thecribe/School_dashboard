...
const renderRow = (eachRow: Assignment) => (
  <tr
    key={eachRow.id}
  ...
  >
    ...
    <td className=" text-gray-800 text-sm">{eachRow.dueDate}</td>
  ...
  return (
    <div className="bg-white flex-1 rounded-md p-4 m-4 flex flex-col gap-5">
      ...
      <div className="flex justify-between w-full items-center ">
        <h1 className="text-lg font-bold hidden md:block">All Assignments</h1>
